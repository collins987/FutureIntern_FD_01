...
const DashboardPage = () => {
	...
	return (
		<motion.div
			...
			className='max-w-md w-full mx-auto mt-10 p-8 bg-gray-800 bg-opacity-90 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl border border-gray-700'
		>
			...
			<div className='space-y-6'>
				<motion.div
					className='p-4 bg-gray-700 bg-opacity-60 rounded-lg border border-gray-600'
